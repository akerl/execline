...
PATH_FLAGS = --prefix=$(RELEASE_DIR) --exec-prefix=$(RELEASE_DIR)/usr --libdir=$(RELEASE_DIR)/usr/lib --includedir=$(RELEASE_DIR)/usr/include
...
push: version
	...
	targit -t -a .github -c -f $(ORG)/$(PACKAGE) $(VERSION) $(RELEASE_FILE)
