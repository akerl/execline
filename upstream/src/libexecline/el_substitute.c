...
#define SUBSUINFO_ZERO { STRALLOC_ZERO, STRALLOC_ZERO, GENALLOC_ZERO, 0 }
...
static int parseword (stralloc *sa, genalloc *list, char const *s, char const *vars, elsubst const *substs, unsigned int nsubst)
{
...
int el_substitute (stralloc *dst, char const *src, unsigned int len, char const *vars, char const *values, elsubst const *substs, unsigned int nsubst)
{
