...
static int el_split (register stralloc *sa, unsigned int base, register eltransforminfo const *si, int chomped)
{
  unsigned int n = 0 ;
...
int el_transform (stralloc *sa, unsigned int i, eltransforminfo const *si)
{
  int chomped = 0 ;
